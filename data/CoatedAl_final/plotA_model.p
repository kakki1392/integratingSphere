...
set output "CoatedAl_A_model.pdf"
set xtics nomirror
set ytics nomirror
set border 3 lw 2
...
plot "coatedAl_confA.txt" u 1:2:xtic(1) w points ls 1 t ' ', "105x105_rho80.txt" u (2*$1):(100*$2) w linespoints ls 2 t ' ', "105x105_rho90.txt" u (2*$1):(100*$2) w linespoints ls 3 t ' '
