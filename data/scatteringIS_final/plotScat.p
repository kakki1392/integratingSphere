...
plot "full_rho90_g0.9_new.txt" u 1:(100*$2) w linespoints ls 1 t ' ', "full_rho95_g0.9_new.txt" u 1:(100*$2) w linespoints ls 2 t ' ', "full_rho99_g0.9_new.txt" u 1:(100*$2) w linespoints ls 3 t ' ' 
unset output
